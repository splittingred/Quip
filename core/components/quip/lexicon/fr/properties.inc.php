...
/* options */
$_lang['quip.all'] = 'Tous';
$_lang['quip.ascending'] = 'Croissant';
$_lang['quip.author'] = 'Auteur';
$_lang['quip.comment'] = 'Commentaire';
$_lang['quip.descending'] = 'Décroissant';
$_lang['quip.family'] = 'Famille';
$_lang['quip.opt_blackglass'] = '« Black Glass »';
$_lang['quip.opt_clean'] = 'Nettoyer';
$_lang['quip.opt_red'] = 'Rouge';
$_lang['quip.opt_white'] = 'Blanc';
$_lang['quip.thread'] = 'Sujet';
$_lang['quip.user'] = 'Utilisateur';
