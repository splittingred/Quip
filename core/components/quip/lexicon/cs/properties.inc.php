...
/* options */
$_lang['quip.all'] = 'Vše';
$_lang['quip.ascending'] = 'Vzestupně';
$_lang['quip.author'] = 'Autor';
$_lang['quip.comment'] = 'Komentář';
$_lang['quip.descending'] = 'Sestupně';
$_lang['quip.family'] = 'Rodina'; // ??? Family
$_lang['quip.opt_blackglass'] = 'Černé brýle'; // ??? Black Glass
$_lang['quip.opt_clean'] = 'Vyčistit';
$_lang['quip.opt_red'] = 'Červená';
$_lang['quip.opt_white'] = 'Bílá';
$_lang['quip.thread'] = 'Vlákno';
$_lang['quip.user'] = 'Uživatel';
...
/* QuipRss */
$_lang['quip.prop_rss_tpl_desc'] = 'Chunk šablona pro jednotlivé RSS položky.';
$_lang['quip.prop_rss_containertpl_desc'] = 'Chunk celkové šablony pro RSS feed.';
$_lang['quip.prop_rss_placeholderprefix_desc'] = 'Předpona (prefix) pro globální placeholdery nastavované v QuipRss.';